...
import { readGrpcBaseUrl, readWalletNetwork, type WalletNetwork } from "./wallet-network";
...
export const dAppKit = createDAppKit({
    ...
    createClient: (network) => new SuiGrpcClient({ network, baseUrl: readGrpcBaseUrl(network) }),
});
