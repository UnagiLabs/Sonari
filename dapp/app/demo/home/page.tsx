...
import { DemoHomeView } from "./demo-home-view";

// デモ用ページは検索エンジンに載せない。本番 / と URL が別なので
// canonical は設定せず、noindex にして本番ホームの正規性を侵さない。
export const metadata: Metadata = {
    title: "Demo · Home — Sonari",
    robots: { index: false, follow: false },
};

// locale ごとの翻訳カタログ。cookie ベース切替のため本番 / と同じく
