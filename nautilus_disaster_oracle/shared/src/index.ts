...
export type TeeCoreResult =
  | {
      ...
      error_code: Extract<OracleErrorCode, "SHAKEMAP_PRODUCT_MISSING" | "SHAKEMAP_GRID_UNAVAILABLE">;
    }
  | {
      status: "pending_mmi";
      source_event_id: string;
...
function firstUnexpectedKey(input: Record<string, unknown>, allowedKeys: readonly string[]): string | undefined {
