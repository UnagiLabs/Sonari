...
describe("AWS earthquake Lambda artifact builder", () => {
    it("creates a CloudFormation-compatible Lambda zip at an overridden output path", async () => {
        ...
        await execFileAsync("pnpm", [
            "tsx",
            "scripts/build_aws_earthquake_lambda.ts",
            "--out",
            outPath,
        ]);
