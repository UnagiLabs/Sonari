...
fun fixed_field_order_identity_result_fixture_decodes() {
    ...
    assert!(provider == identity_result_v1::provider_world_id());
    assert!(verified);
    assert!(
        duplicate_key_hash ==
    ...
    assert!(
        evidence_hash == x"5555555555555555555555555555555555555555555555555555555555555555",
    );
...
fun identity_result_bcs(): vector<u8> {
    x""
}
